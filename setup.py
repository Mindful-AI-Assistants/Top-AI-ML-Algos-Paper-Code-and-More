...
setup(  
    name='SP2024-Election-Analysis',                  # Substitua pelo nome do seu projeto  
    ...
    url='https://github.com/Mindful-AI-Assistants/SP2024-Election-Analysis"  # URL do repositório do seu projeto  
